...
def divizibil(l,k):
    '''
        Ne afiseaza cea mai lunga subsecventa de numere divizibile cu un numar dat
        :param l:
        :return:
        '''
...
def medie(l, med):
    '''
           Ne afiseaza cea mai  lunga subsecventa a caror medie nu depaseste o valoare citita
           :param l:
           :return:
     '''
    list = []
